...
exports.Lemmatizer = function () {

	var successfull = new Parse.Promise();

	this.wn_files = {
		verb: [
			'www.refocustech.in/orange/dict/index.verb.json',
			'www.refocustech.in/orange/dict/verb.exc.json'
		]
		/*,
		adj: [
			'www.refocustech.in/orange/dict/index.adj.json',
			'www.refocustech.in/orange/dict/adj.exc.json'
		],
		adv: [
			'www.refocustech.in/orange/dict/index.adv.json',
			'www.refocustech.in/orange/dict/adv.exc.json'
		],
		noun: [
			'www.refocustech.in/orange/dict/index.noun.json',
			'www.refocustech.in/orange/dict/noun.exc.json'
		]
		*/
	};
...
exports.Lemmatizer.prototype = {
	...
	initialize: function () {
		var successPromise = new Parse.Promise();
		...
		var file = localStorage.getItem(key_idx);
		...
		Parse.Cloud.httpRequest({
			...
			var key_exc = pos + self.exc;
			file = localStorage.getItem(key_exc);
